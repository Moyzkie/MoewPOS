    ...
    <div class="container">
      <div class="row ">
        ...
        <div id="column-right" class="col-sm-8 col-md-8 col-lg-9 mtb_30">
          ...
          <div class="row">
          <?php foreach ($groupMenu->result() as $row) { ?>
          <div class="product-layout  product-grid  col-lg-3 col-md-4 col-sm-6 col-xs-12 ">
                <div class="item">
                  <div class="product-thumb  mb_30">
                    <div class="image product-imageblock"> <a href=""> <img data-name="product_image" src="<?=base_url('assets/images/product/').$row->picture?>" alt="iPod Classic" title="iPod Classic" class="img-responsive" /> <img src="<?=base_url('assets/images/product/').$row->picture?>" alt="iPod Classic" title="iPod Classic" class="img-responsive" /> </a> </div>
